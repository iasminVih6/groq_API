API Groq — Estudo
Uma API simples em Python que recebe uma pergunta e devolve a resposta gerada por um modelo de IA, usando a Groq.
...
Você manda uma pergunta em texto para a rota /perguntar.
O Flask recebe, valida e repassa a pergunta para a Groq.
A Groq processa com um modelo de IA e devolve uma resposta.
O Flask extrai o texto da resposta e devolve para você em JSON.
Tecnologias
Python 3.11
...
Adicionar um front-end simples para não depender de cur
